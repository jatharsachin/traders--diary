...
export type Mistake = 'None' | 'Overtrading' | 'FOMO Entry' | 'Moving SL' | 'Early Exit' | 'No Setup' | 'Late Exit' | 'Panic Exit' | 'Greed Hold' | 'Manual Intervention' | 'Tech / API Issue' | '10K' | '10K Drawdown' | (string & {});
